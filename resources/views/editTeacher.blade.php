...
<div class="form-container">
    ...
    <div id="teacher-edit-panel">
        <input type="hidden" id="id" value="{{ $teacher->id }}">
        <input type="hidden" id="f_name" value="">
        ...
        <button type="button" id="updateTeacherBtn" class="btn-submit">Update Teacher</button>
        <a href="{{ route('teachers.show', $teacher->id) }}" class="btn-back">Back</a>
    </div>
</div>
@endsection
